...
function listen(log, host, port, argv) {
    ...
    argv = {
        ...
        secure: argv.https || argv.h,
        cache: argv.c || argv.cache,
        noStrip: argv.ns || argv.nostrip,
	silent: argv.s || argv.silent,
        markdown: !(argv.nm || argv.nomarkdown),
        sessions: sessions,
        wsServer: argv.ws || argv.websocket,
        log: argv.l || argv.log,
    ...
    server.listen(port, host, function() {
        ...
        log('Strip sign: '.grey + getOptionString(argv.stripSign));
        log('Fragments '.grey +
        ...
        log('Log '.grey + (typeof argv.log === 'string' ? argv.log.green : getOptionString(argv.log)));
