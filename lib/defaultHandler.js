/*global unescape:false module:false require:false */
...
var send, recast, options, pathMap = {}, debug;
    ...
    if (options.prerender) {
        ...
        if (options.fragment &&  url.query &&
            ...
            return true;
                 ...
                 req.url.hash.startsWith('#!')) return true;
    }
    return false;
}
...
//         wash(url, { phantomPath: options.phantomPath,
    ...
    if (isPrerender(req)) {
        ...
        if (mimeType) {
            ...
            if (req.$fromBot) {
                ...
                //TODO rewrite url to options.spa || 'index.html'
                req.$file = true;
            }
        }
        //no spa:
